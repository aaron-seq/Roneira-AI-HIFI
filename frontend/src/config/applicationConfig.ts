...
export class ApplicationConfiguration {
  ...
  constructor() {
    ...
    this.apiBaseUrl = import.meta.env.VITE_API_BASE_URL || 
      (this.isDevelopment ? 'http://localhost:3001' : 'https://api.roneira-hifi.com');
    
    this.wsEndpoint = import.meta.env.VITE_WS_ENDPOINT || 
      (this.isDevelopment ? 'ws://localhost:3001' : 'wss://api.roneira-hifi.com');
