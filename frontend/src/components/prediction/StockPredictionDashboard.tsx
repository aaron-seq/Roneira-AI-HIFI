  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-cyan-400 mb-4">Stock Price Prediction</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-white">
              Prediction for <span className="text-cyan-400">{prediction.ticker_symbol}</span>
            </h3>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className={`text-xl font-bold ${
                    prediction.predicted_percentage_change > 0 ? 'text-green-400' : 'text-red-400'
                  }`}>
                    {prediction.predicted_percentage_change > 0 ? '+' : ''}
                ...
                <div className="flex items-center gap-2">
                  <div className="w-20 h-2 bg-gray-600 rounded-full">
                    <div 
                      ...
                      style={{ width: `${prediction.model_accuracy_r2_score * 100}%` }}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`px-2 py-1 rounded text-xs font-semibold ${
                      prediction.market_sentiment.label === 'POSITIVE' ? 'bg-green-600' :
                      prediction.market_sentiment.label === 'NEGATIVE' ? 'bg-red-600' :
                      'bg-gray-600'
                    }`}>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-white">Technical Indicators</h3>
            ...
            <div className="space-y-3">
              {prediction.technical_indicators?.relative_strength_index && (
                <div className="flex justify-between">
                  ...
                  <span className={`font-semibold ${
                    prediction.technical_indicators.relative_strength_index > 70 ? 'text-red-400' :
                    prediction.technical_indicators.relative_strength_index < 30 ? 'text-green-400' :
                    'text-gray-300'
                  }`}>
                    {prediction.technical_indicators.relative_strength_index.toFixed(1)}
                  </span>
                </div>
              )}
              ...
              {prediction.technical_indicators?.macd_line && (
                <div className="flex justify-between">
                  ...
                  <span className={`font-semibold ${
                    prediction.technical_indicators.macd_line > 0 ? 'text-green-400' : 'text-red-400'
                  }`}>
              ...
              {prediction.technical_indicators?.bollinger_position && (
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-300 font-semibold">
                    {(prediction.technical_indicators.bollinger_position * 100).toFixed(0)}%
                  </span>
                </div>
              )}
            </div>
          ...
          {prediction.pdm_strategy_analysis && (
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-white">PDM Strategy Analysis</h3>
              
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-400">Signal:</span>
                  <span className={`px-2 py-1 rounded text-xs font-semibold ${
                    prediction.pdm_strategy_analysis.signal_type === 'LONG' ? 'bg-green-600' :
                    prediction.pdm_strategy_analysis.signal_type === 'EXIT' ? 'bg-red-600' :
                    'bg-gray-600'
                  }`}>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-cyan-400 font-semibold">
                    {(prediction.pdm_strategy_analysis.confidence_score * 100).toFixed(0)}%
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`font-semibold ${
                    prediction.pdm_strategy_analysis.price_velocity > 0 ? 'text-green-400' : 'text-red-400'
                  }`}>
                    {prediction.pdm_strategy_analysis.price_velocity.toFixed(2)}
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-yellow-400 font-semibold">
                    {prediction.pdm_strategy_analysis.institutional_volume_factor.toFixed(2)}x
                  </span>
                </div>
